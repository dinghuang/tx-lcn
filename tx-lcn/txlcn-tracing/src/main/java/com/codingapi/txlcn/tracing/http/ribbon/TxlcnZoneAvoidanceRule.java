...
import com.codingapi.txlcn.tracing.spring.util.TracingSpringContextUtils;
...
public class TxlcnZoneAvoidanceRule extends ZoneAvoidanceRule {
    ...
    public Server choose(Object key) {
        ...
        if (!exitHost) {
            ...
            TracingContext.tracing().addApp(registration.getServiceId().toUpperCase(), springConfig.getHost() + ":" + springConfig.getPort());
        } else {
